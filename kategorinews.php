			...
			<div class="col-sm-9">
				<h1><?php 
				    $tags = mysql_real_escape_string($_GET['tags']);
						$sql=mysql_query("select * from v_kategori where katberita_seo='$tags'");
...
<section class="blog">
	<div class="container">
        ...
        include 'adminku/configurasi/paginationkat.php';
        	$id = mysql_real_escape_string($_GET['tags']);       
  ...
  <input name="keyword" class="form-control search-form" placeholder="Pencarian artikel..." type="text"><span class="fa fa-search form-control-feedback"></span>
				...
				<a href="">
					...
					<a href="">
						...
						<?php 
						$artikel=mysql_query("SELECT id_berita,nama_berita,nama_kat,gambar,nama_beritaseo From v_berita ORDER BY id_berita DESC limit 5");
